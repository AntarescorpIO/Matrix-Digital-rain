...
#define LINE_WIDTH 14             //width for font size 2
#define LETTER_HEIGHT 20          //height for font size 2
...
public:
  ...
  void setTextAnimMode(AnimMode animMode, std::string msg, int startX = 20, int startY = 20, int text_timeFrame = 100) {
    _animMode = animMode;
    setAnimText(msg);
    textStartX = startX;
    textStartY = startY;
